...
export function MockLectureCard() {
  const mockLecture = {
    id: 'mock-lecture',
    ...
    >
      <div className={`h-48 bg-gradient-to-br ${gradient} relative overflow-hidden`}>
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-2">
          ...
          <span className="bg-white/90 text-primary text-xs font-semibold px-2 py-1 rounded capitalize flex items-center gap-1" data-testid="mock-text-category">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          <span className="flex items-center" data-testid="mock-text-author">
            <User className="w-3 h-3 mr-1" />
            {mockLecture.author}
          </span>
          <span className="flex items-center" data-testid="mock-text-date">
