    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-primary/5 to-secondary/5">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground">
          <p data-testid="text-teacher-info">Teachers: Use your institutional email to sign in</p>
          <p data-testid="text-student-info">Students: Browse lectures without signing in</p>
        </div>
      </div>
    </section>
  );
